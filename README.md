...
**Current release: 10.0.0 RC188 — Undertaking Mobile Actions & Signature Repair**
...
- يتضمن RC188 patch آمنًا لإصلاح ربط التوقيع في التعهدات القديمة وتحديث قالب التعهد؛ لذلك يجب تشغيل `migrate` بعد الرفع.
