...
def shell(title_ar, title_en, body_blocks, footer_y=1000):
    blocks = [
        ...
        b("title", "text", 48, 104, 697, 54,
          f'<div style="text-align:center;font-size:24px;font-weight:700;">{title_ar}</div>'
          f'<div style="text-align:center;font-size:11px;color:#666;">{title_en}</div>'),
    ]
    blocks.extend(body_blocks)
    blocks.append(b("footer", "text", 48, footer_y, 697, 48,
...
def invoice_canvas():
    ...
    return shell("فاتورة ضريبية", "TAX INVOICE", [
        ...
        b("status", "field", 48, 842, 697, 38, '<div style="direction:rtl;text-align:center;font-size:11px;border:1px solid #b88a2a;padding:8px;"><b>حالة الفاتورة / Status:</b> {{ doc.status or "" }}</div>'),
    ], footer_y=940)
...
def undertaking_canvas():
    ...
    return shell("تعهد تقديم خدمات الإعاشة", "CATERING SERVICES UNDERTAKING", [
        ...
        b("signatory", "field", 48, 842, 300, 100, '<div style="direction:rtl;text-align:center;font-size:11px;line-height:1.8;"><b>شركة وفد المدينة لخدمات الإعاشة</b><br>{{ doc.authorized_signatory or doc.company_representative or "الممثل المعتمد" }}<br>{{ doc.signatory_title or "" }}<br>التوقيع: ____________________</div>'),
        b("signature", "signature", 395, 835, 140, 88, src='{{ doc.signature_image or "" }}', z=10),
        b("stamp", "stamp", 565, 820, 130, 120, src='{{ doc.company_stamp or "" }}', z=10),
    ], footer_y=974)
...
def generic_operational(title_ar, title_en, rows, extra_html=""):
    return shell(title_ar, title_en, [
        ...
        b("extra", "field", 48, 562, 697, 300, extra_html or '<div style="direction:rtl;border:1px solid #ddd;padding:12px;font-size:11px;line-height:1.8;"><b>ملاحظات / Notes</b><br>{{ doc.notes or "" }}</div>'),
        b("approval", "text", 48, 882, 697, 72, '<table style="width:100%;direction:rtl;font-size:11px;"><tr><td style="text-align:center;">أعده / Prepared by<br><br>________________</td><td style="text-align:center;">راجعه / Reviewed by<br><br>________________</td><td style="text-align:center;">اعتمده / Approved by<br><br>________________</td></tr></table>'),
    ], footer_y=998)
