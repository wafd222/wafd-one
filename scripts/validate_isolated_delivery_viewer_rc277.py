...
require("syncPwaChrome(home || deliveryViewer)" in nav, "viewer Frappe chrome is not hidden")
...
require('viewerOnly = profile.role === "WAFD Delivery Viewer"' in home, "viewer-only role-home menu missing")
require("v10_0_0_rc277.execute" in read("wafd_one/patches.txt"), "RC277 patch missing")
require('version = "10.0.0rc277"' in read("pyproject.toml"), "RC277 version mismatch")
