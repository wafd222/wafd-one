...
def undertaking_canvas():
    ...
    return _header("تعهد والتزام إعاشة","CATERING SERVICES UNDERTAKING",[
        ...
        _block("terms","field",48,640,697,92,'<div style="direction:rtl;border:1px solid #ddd;padding:9px;font-size:10.5px;line-height:1.65;"><b>الشروط والملاحظات / Terms & Notes</b><br>{{ doc.additional_terms or doc.service_notes or "تلتزم الشركة بالمواعيد والكميات المعتمدة وباشتراطات سلامة الغذاء والنقل والتسليم." }}</div>'),
        _block("signatory","field",70,755,285,82,'<div style="direction:rtl;text-align:center;font-size:10.5px;line-height:1.7;"><b>شركة وفد المدينة لخدمات الإعاشة</b><br>{{ doc.authorized_signatory or doc.company_representative or "الممثل المعتمد" }}<br>{{ doc.signatory_title or "" }}<br>التوقيع: ____________________</div>'),
        _block("signature","signature",405,748,125,76,src='{{ doc.signature_image or "" }}',z=10),
        _block("stamp","stamp",570,740,120,92,src='{{ doc.company_stamp or "" }}',z=10),
    ])
