...
def get_portal_data():
    ...
    if mode == "none":
        allowed = GLOBAL_MANAGEMENT_ROLES | {PROJECT_MANAGER_ROLE, KITCHEN_ROLE, DELIVERY_ROLE, EXTERNAL_VIEWER_ROLE}
...
def save_project_team(project_name, project_manager_user=None, kitchen_supervisor_user=None,
                      delivery_supervisor_user=None, external_viewer_user=None):
