frappe.pages["wafd-employee-team"].on_page_load = function (wrapper) {
    ...
    <div class="wafd-employee-shell">
      <section class="wafd-employee-card">
        ...
        <div class="wafd-employee-form">
          ...
          <div class="wafd-employee-field"><label>${tr("رقم الجوال", "Mobile number")}</label><input id="wafd-employee-mobile" type="tel" dir="ltr" autocomplete="tel"><small class="wafd-driver-note">${tr("رقم الجوال مطلوب عند اختيار سائق.", "A mobile number is required for a driver.")}</small></div>
    ...
    const dialog = new frappe.ui.Dialog({
      ...
      primary_action: (values) => {
        ...
        frappe.call({
          ...
          args: {user: employee.name, role, mobile: values.mobile},
          freeze: true,
  ...
  $root.on("click", "#wafd-add-employee", function () {
    const args = {
      ...
      mobile: $root.find("#wafd-employee-mobile").val(),
