  ...
  $root.html(`
    <div class="wafd-command-center">
      ...
      <section class="wafd-action-grid">
        ...
        <button class="wafd-action" data-route="wafd-delivery-report"><b>▤</b><span>تقارير التوصيل</span><small>تقارير الشركات والفنادق بصيغة PDF</small></button>
      </section>
      ...
      <section class="wafd-hub-grid">
        ...
        <button class="wafd-hub-card wafd-hub-card-iftar" data-route="wafd-iftar-team" data-roles="System Manager|WAFD Operations Manager|WAFD Project Manager|WAFD Delivery Supervisor|WAFD Storekeeper"><b>☾</b><span>إفطار صائم</span><small>المشاريع الموسمية والتشغيل اليومي والتقارير</small></button>
        ...
        <article class="wafd-detail-group">
          ...
          <div class="wafd-detail-panel">
            <section class="wafd-manager-overview wafd-ops-overview">
              ...
              <article class="wafd-card wafd-overview-card"><div class="wafd-card-head"><div><h3>تشغيل إفطار صائم</h3><small>عمليات مرتبطة بعقد وعمليات مستقلة</small></div><button data-route="wafd-iftar-team">فتح البيانات</button></div><div class="wafd-today-ops wafd-iftar-summary"></div></article>
            </section>
